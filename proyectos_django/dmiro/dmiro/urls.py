...
urlpatterns = [
    ...
    url(r'^app/api/fusionCircular3DAgencias/', views.fusionCircular3DAgencias, name='fusionCircular3DAgencias'),
    url(r'^app/api/fusionCircular3DProductos/', views.fusionCircular3DProductos, name='fusionCircular3DProductos'),
    url(r'^app/api/fusionBarrasProductos/', views.fusionBarrasProductos, name='fusionBarrasProductos'),
    url(r'^app/api/fusionLinesGeneral/', views.fusionLinesGeneral, name='fusionLinesGeneral'),
